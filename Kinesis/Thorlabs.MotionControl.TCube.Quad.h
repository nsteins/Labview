...
extern "C"
{
	...
	enum QD_OpenLoopHoldValues : short
	{
	...
	/// <remarks>Not used by HW version &lt; 3</remarks>
	struct QD_LowPassFilterParameters
	{
		/// <summary> The low pass filter cut off frequency, range 0 to 10000. </summary>
		/// <remarks>Not used by HW version &lt; 3</remarks>
		float lowPassFilterCutOffFreq;
	...
	/// <remarks>Not used by HW version &lt; 3</remarks>
	struct QD_NotchFilterParameters
	{
		/// <summary> The notch filter center frequency, range 0 to 10000. </summary>
		/// <remarks>Not used by HW version &lt; 3</remarks>
		float notchFilterCenterFrequency;
	...
	struct QD_PositionDemandParameters
	{
...
#pragma pack()
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBEQUAD_API short _cdecl TLI_GetDeviceInfo(char const * serialNo, TLI_DeviceInfo *info);
	...
	/// <remarks> This feature was added to the TPA101 device, hardware version &lt 3</remarks>
	/// <param name="serialNo"> The device serial no. </param>
	...
	/// <remarks> This feature was added to the TPA101 device, hardware version &lt 3</remarks>
	/// <param name="serialNo"> The device serial no. </param>
	/// <param name="notchParams"> Address of the QD_NotchFilterParameters containing the new Feedback Notch Filter Parameters. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	/// <seealso cref="QD_GetNotchFilterparams(char const *serialNo, QD_NotchFilterParameters *notchParams)" />
	/// <seealso cref="QD_GetLowPassFilterparams(char const *serialNo, QD_LowPassFilterParameters *lowPassParams)" />
	/// <seealso cref="QD_SetLowPassFilterparams(char const *serialNo, QD_LowPassFilterParameters *lowPassParams)" />
	...
	/// <seealso cref="QD_SetPIDparams(char const *serialNo, QD_PIDParameters *proportionalIntegralDifferentialParams)" />
	/// <seealso cref="QD_GetPIDparams(char const *serialNo, QD_PIDParameters *proportionalIntegralDifferentialParams)" />
	TCUBEQUAD_API short __cdecl QD_SetNotchFilterparams(char const *serialNo, QD_NotchFilterParameters *notchParams);
