...
extern "C"
{
	...
	BENCHPIEZO_API void __cdecl PBC_Identify(char const * serialNo);
	...
	BENCHPIEZO_API bool __cdecl PBC_LoadSettings(char const * serialNo);
	...
	BENCHPIEZO_API short __cdecl PBC_SetMaxOutputVoltage(char const * serialNo, short channel, short eVoltage);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHPIEZO_API short __cdecl PBC_GetSlewRates(const char * serialNo, short channel, PZ_SlewRates *slewRates);
	...
	/// <param name="slewRates"> The open mode and closed mode rates. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHPIEZO_API short __cdecl PBC_SetSlewRates(const char * serialNo, short channel, PZ_SlewRates *slewRates);
}
/** @} */ // BenchtopPiezo
