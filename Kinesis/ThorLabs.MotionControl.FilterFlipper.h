...
extern "C"
{
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	FILTERFLIPPERDLL_API short _cdecl TLI_GetDeviceInfo(char const * serialNo, TLI_DeviceInfo *info);
	...
	FILTERFLIPPERDLL_API void FF_Identify(char const * serialNo);
	...
	FILTERFLIPPERDLL_API short FF_GetIOSettings(const char * serialNo, FF_IOSettings *settings);
	...
	FILTERFLIPPERDLL_API short FF_SetIOSettings(const char * serialNo, FF_IOSettings *settings);
	...
	FILTERFLIPPERDLL_API unsigned int FF_GetTransitTime(const char * serialNo);
	...
	FILTERFLIPPERDLL_API short FF_SetTransitTime(const char * serialNo, unsigned int transitTime);
