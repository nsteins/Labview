...
extern "C"
{
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	BRUSHLESSMOTOR_API short _cdecl TLI_GetDeviceInfo(char const * serialNo, TLI_DeviceInfo *info);
	...
	BRUSHLESSMOTOR_API  short BMC_GetMMIParams(char const * serialNo, KMOT_JoyStickMode *joystickMode, __int32 *joystickMaxVelocity, __int32 *joystickAcceleration, KMOT_JoystickDirectionSense *directionSense,
	...
	/// <seealso cref="BMC_SetMMIParamsBlock(const char * serialNo, KMOT_MMIParams *mmiParams)" />
	/// <seealso cref="BMC_GetMMIParamsBlock(const char * serialNo, KMOT_MMIParams *mmiParams)" />
	BRUSHLESSMOTOR_API short BMC_SetMMIParams(char const * serialNo, KMOT_JoyStickMode joystickMode, __int32 joystickMaxVelocity, __int32 joystickAcceleration, KMOT_JoystickDirectionSense directionSense,
								   __int32 presetPosition1, __int32 presetPosition2, __int16 displayIntensity);
