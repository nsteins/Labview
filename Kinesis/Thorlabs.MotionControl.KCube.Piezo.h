...
extern "C"
{
	...
	/// <summary> Values that represent KPZ_JoystickDirectionSense. </summary>
	enum KPZ_JoystickDirectionSense : __int16
	{
	...
	/// <summary> Values that represent KPZ_JoyStickMode. </summary>
	enum KPZ_JoyStickMode : __int16
	{
	...
	enum KPZ_JoyStickChangeRate : __int16
	{
	...
	enum KPZ_TriggerPortMode : __int16
	{
		KPZ_TrigDisabled = 0x00,//< Trigger Disabled
		KPZ_TrigIn_GPI = 0x01,///< General purpose logic input
		...
		KPZ_TrigOut_GPO = 0x0A,///< General purpose output (set using MOT_SET_DIGOUTPUTS)
	};

		/// <summary> Values that represent MOT_JoyStickMode. </summary>
	enum KPZ_TriggerPortPolarity : __int16
	{
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	KCUBEPIEZO_API short _cdecl TLI_GetDeviceInfo(char const * serialNo, TLI_DeviceInfo *info);
	...
	/// <seealso cref="PCC_SetMaxOutputVoltage(char const * serialNo, short eVoltage)" />
	...
	KCUBEPIEZO_API short __cdecl PCC_SetMaxOutputVoltage(char const * serialNo, short eVoltage);
	...
	KCUBEPIEZO_API  short PCC_GetMMIParams(char const * serialNo, KPZ_JoyStickMode *joystickMode, KPZ_JoyStickChangeRate *voltageAdjustRate, __int32 *voltageStep, KPZ_JoystickDirectionSense *directionSense,
	...
	/// <seealso cref="PCC_SetMMIParamsBlock(const char * serialNo, KPZ_MMIParams *mmiParams)" />
	/// <seealso cref="PCC_GetMMIParamsBlock(const char * serialNo, KPZ_MMIParams *mmiParams)" />
	KCUBEPIEZO_API short PCC_SetMMIParams(char const * serialNo, KPZ_JoyStickMode joystickMode, KPZ_JoyStickChangeRate voltageAdjustRate, __int32 voltageStep, KPZ_JoystickDirectionSense directionSense,
								   __int32 presetVoltage1, __int32 presetVoltage2, __int16 displayIntensity);
	...
	KCUBEPIEZO_API  short PCC_GetTriggerConfigParams(char const * serialNo, KPZ_TriggerPortMode *trigger1Mode, KPZ_TriggerPortPolarity *trigger1Polarity, KPZ_TriggerPortMode *trigger2Mode, KPZ_TriggerPortPolarity *trigger2Polarity);
	...
	/// <seealso cref="PCC_SetTriggerConfigParamsBlock(const char * serialNo, KPZ_TriggerConfig *triggerConfigParams)" />
	/// <seealso cref="PCC_GetTriggerConfigParamsBlock(const char * serialNo, KPZ_TriggerConfig *triggerConfigParams)" />
	KCUBEPIEZO_API short PCC_SetTriggerConfigParams(char const * serialNo, KPZ_TriggerPortMode trigger1Mode, KPZ_TriggerPortPolarity trigger1Polarity, KPZ_TriggerPortMode trigger2Mode, KPZ_TriggerPortPolarity trigger2Polarity);
	...
	/// <seealso cref="PCC_SetMMIParams(char const * serialNo, KPZ_JoyStickMode joystickMode, KPZ_JoyStickChangeRate voltageAdjustRate, __int32 voltageStep, KPZ_JoystickDirectionSense directionSense, __int32 presetVoltage1, __int32 presetVoltage2, __int16 displayIntensity)" />
	/// <seealso cref="PCC_SetMMIParamsBlock(const char * serialNo, KPZ_MMIParams *mmiParams)" />
	KCUBEPIEZO_API short PCC_GetMMIParamsBlock(char const * serialNo, KPZ_MMIParams *mmiParams);
	...
	/// <seealso cref="PCC_SetMMIParams(char const * serialNo, KPZ_JoyStickMode joystickMode, KPZ_JoyStickChangeRate voltageAdjustRate, __int32 voltageStep, KPZ_JoystickDirectionSense directionSense, __int32 presetVoltage1, __int32 presetVoltage2, __int16 displayIntensity)" />
	/// <seealso cref="PCC_GetMMIParamsBlock(const char * serialNo, KPZ_MMIParams *mmiParams)" />
	KCUBEPIEZO_API short PCC_SetMMIParamsBlock(char const * serialNo, KPZ_MMIParams *mmiParams);
	...
	/// <seealso cref="PCC_SetTriggerConfigParams(char const * serialNo, KPZ_TriggerPortMode trigger1Mode, KPZ_TriggerPortPolarity trigger1Polarity, KPZ_TriggerPortMode trigger2Mode, KPZ_TriggerPortPolarity trigger2Polarity)" />
	/// <seealso cref="PCC_SetTriggerConfigParamsBlock(const char * serialNo, KPZ_TriggerConfig *triggerConfigParams)" />
	KCUBEPIEZO_API short PCC_GetTriggerConfigParamsBlock(char const * serialNo, KPZ_TriggerConfig *triggerConfigParams);
	...
	/// <seealso cref="PCC_SetTriggerConfigParams(char const * serialNo, KPZ_TriggerPortMode trigger1Mode, KPZ_TriggerPortPolarity trigger1Polarity, KPZ_TriggerPortMode trigger2Mode, KPZ_TriggerPortPolarity trigger2Polarity)" />
	/// <seealso cref="PCC_GetTriggerConfigParamsBlock(const char * serialNo, KPZ_TriggerConfig *triggerConfigParams)" />
	KCUBEPIEZO_API short PCC_SetTriggerConfigParamsBlock(char const * serialNo, KPZ_TriggerConfig *triggerConfigParams);
}
/** @} */ // KCubePiezo
