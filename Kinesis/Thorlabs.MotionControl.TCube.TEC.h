...
extern "C"
{
	...
	enum TC_SensorTypes : unsigned short
	{
	...
	enum TC_DisplayModes : unsigned short
	{
...
#pragma pack()
	...
	/// <seealso cref="TLI_GetDeviceListByTypeExt(char *receiveBuffer, DWORD sizeOfBuffer, int typeID)" />
	/// <seealso cref="TLI_GetDeviceListByTypesExt(char *receiveBuffer, DWORD sizeOfBuffer, int * typeIDs, int length)" />
	TCUBETEC_API short _cdecl TLI_GetDeviceInfo(char const * serialNo, TLI_DeviceInfo *info);
	...
	TCUBETEC_API WORD __cdecl TC_GetLEDBrightness(char const * serialNo);
