...
extern "C"
{
	...
	MODULARRACK_API short __cdecl  NT_SetNTChannels(short chanA, short chanB);
	...
	/// <seealso cref="NT_GetNTChannels(short &chanA, short &chanB)" />
	MODULARRACK_API short __cdecl NT_RequestNTChannels();
	...
	/// <seealso cref="NT_SetNTChannels(short chanA, short chanB)" />
	/// <seealso cref="NT_RequestNTChannels()" />
	MODULARRACK_API short __cdecl NT_GetNTChannels(short &chanA, short &chanB);
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	MODULARRACK_API short __cdecl NT_GetMaxTravel(double &chanA, double &chanB);
}
