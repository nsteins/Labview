...
int	E816_FUNC_DECL E816_SetTimeout(int ID, int timeout);

int	E816_FUNC_DECL E816_ConnectTCPIP(const char* szHostname, long port);
int E816_FUNC_DECL E816_EnumerateTCPIPDevices(char* szBuffer, long iBufferSize);
int E816_FUNC_DECL E816_ConnectTCPIPByDescription(const char* szDescription);

int E816_FUNC_DECL E816_EnumerateUSB(char* szBuffer, long iBufferSize, const char* szFilter);
int E816_FUNC_DECL E816_ConnectUSB(const char* szDescription);
...
BOOL E816_FUNC_DECL E816_qHLP(int ID, char* szBuffer, int maxlen);
